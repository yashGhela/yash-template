...
export default function LandingSteps(){
    ...
    return(
        <div className="mt-[10%] flex-col">
            ...
            <button onClick={()=>{router.push('/auth')}} className={`font-bold w-[40%] md:w-[25%] text-white text-xl rounded-md bg-blue-300 hover:bg-blue-400 mt-20  md:h-14 p-2 mr-1`}>Start Now</button>
        </div>
    )
}