  ...
  const router = useRouter()
    return(
      ...
      <SmoothScrollLink to='features' >Features</SmoothScrollLink>
       ...
       <motion.button whileHover={{scale:1.05}} onClick={()=>{router.push('/auth')}} className={`font-bold shadow-lg  md:w-full md:h-full  h-24 text-sm   text-white md:text-md rounded-xl bg-blue-400 hover:bg-blue-600 -mt-1 ml-2   p-2 mr-1`}>Start Now</motion.button>
